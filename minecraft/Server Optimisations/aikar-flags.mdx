...
<Warning>It’s common for people to think that giving more RAM to your server will solve all your problems. However this often can at best not solve any issues, and at worse, make the server crash more frequently.</Warning>