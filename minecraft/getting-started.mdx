...
You may use a tool like [this one]{https://mctools.org/motd-creator}, copy it directly to `server-properties`. If you have set it up correctly then following a restart the server will update automatically.
...
When adding a datapack into your server, you must first navigate to the **File Manager** tab and access the `world` folder. Within this folder, you will discover a designated directory named **/datapacks/. Open this directory to proceed with the upload process. You can either drag and drop the desired datapack into the folder or use the `Upload` button.
